...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Load spaces data (use spaces_ja.json for bilingual support)
  fetch('spaces_ja.json')
  ...
  function renderSpaces(spacesList) {
    ...
    spacesList.forEach(space => {
      ...
      card.onclick = () => viewSpace(space.id);
      ...
      card.innerHTML = `
        ...
        <div class="space-info">
          ...
          <p class="space-description">
            <span class="jp">${titleNum}．${descJa}</span><br>
            ${descEn}
          </p>
  ...
  function viewSpace(spaceId) {
    window.location.href = `index.html?space=${spaceId}`;
  }
});
